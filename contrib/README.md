...
All other packaging related files can be found in the [earthcoin-core/packaging](https://github.com/earthcoin-core/packaging) repository.

### [Gitian-descriptors](/contrib/gitian-descriptors) ###
Files used during the gitian build process. For more information about gitian, see the [the Earthcoin Core documentation repository](https://github.com/earthcoin-core/docs).
