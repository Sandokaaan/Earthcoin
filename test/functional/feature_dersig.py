...
class BIP66Test(EarthcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # earthcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and earthcoind produces more specific reject
            # reasons.
