...
"""Verify that starting earthcoin with -h works as expected."""

from test_framework.test_framework import EarthcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(EarthcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start earthcoin with -h for help text")
        ...
        self.log.info("Start earthcoin with -version for version information")
        ...
        self.log.info("Start earthcoind with -fakearg to make sure it does not start")
