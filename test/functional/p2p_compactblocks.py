...
# TestP2PConn: A peer we use to send messages to earthcoind, and store responses.
...
class CompactBlocksTest(EarthcoinTestFramework):
    ...
    # This test actually causes earthcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that earthcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for earthcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # earthcoind will not send blocktxn responses for blocks whose height is
