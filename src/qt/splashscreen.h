...
#ifndef EARTHCOIN_QT_SPLASHSCREEN_H
#define EARTHCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Earthcoin Core initialization
...
#endif // EARTHCOIN_QT_SPLASHSCREEN_H
