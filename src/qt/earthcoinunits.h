...
#ifndef EARTHCOIN_QT_EARTHCOINUNITS_H
#define EARTHCOIN_QT_EARTHCOINUNITS_H
...
/** Earthcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EarthcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EarthcoinUnits(QObject *parent);

    /** Earthcoin units.
      @note Source: https://en.earthcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EAC,
...
typedef EarthcoinUnits::Unit EarthcoinUnit;

#endif // EARTHCOIN_QT_EARTHCOINUNITS_H
