...
public:
    ...
    QPushButton *openEarthcoinConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        earthcoinAtStartup = new QCheckBox(tabMain);
        earthcoinAtStartup->setObjectName(QStringLiteral("earthcoinAtStartup"));

        verticalLayout_Main->addWidget(earthcoinAtStartup);
        ...
        openEarthcoinConfButton = new QPushButton(OptionsDialog);
        openEarthcoinConfButton->setObjectName(QStringLiteral("openEarthcoinConfButton"));
        openEarthcoinConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openEarthcoinConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        earthcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        earthcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Earthcoin client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Earthcoin network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Earthcoin network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openEarthcoinConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openEarthcoinConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
