...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        WalletSelectorLabel->setObjectName(QStringLiteral("WalletSelectorLabel"));

        horizontalLayout->addWidget(WalletSelectorLabel);

        WalletSelector = new QComboBox(tab_console);
        WalletSelector->setObjectName(QStringLiteral("WalletSelector"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Debug window", Q_NULLPTR));
        ...
        WalletSelectorLabel->setText(QApplication::translate("RPCConsole", "Wallet: ", Q_NULLPTR));
        WalletSelector->clear();
        WalletSelector->insertItems(0, QStringList()
         << QApplication::translate("RPCConsole", "(none)", Q_NULLPTR)
        );
