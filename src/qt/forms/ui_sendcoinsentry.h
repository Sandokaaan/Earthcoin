...
#include "qt/earthcoinamountfield.h"
...
public:
    ...
    EarthcoinAmountField *payAmount;
    ...
    QHBoxLayout *horizontalLayoutMessageCID;
    QLineEdit *cidTextLabel;
    QCheckBox *checkBoxCID;
    ...
    EarthcoinAmountField *payAmount_is;
    ...
    EarthcoinAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        messageTextLabel = new QLineEdit(SendCoins);
        messageTextLabel->setObjectName(QStringLiteral("messageTextLabel"));

        gridLayout->addWidget(messageTextLabel, 6, 2, 1, 1);
        ...
        gridLayout->addLayout(payToLayout, 0, 2, 1, 1);
        ...
        gridLayout->addLayout(horizontalLayoutAmount, 3, 2, 1, 1);

        cidLabel = new QLabel(SendCoins);
        cidLabel->setObjectName(QStringLiteral("cidLabel"));
        cidLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(cidLabel, 7, 0, 1, 1);
        ...
        gridLayout->addWidget(addAsLabel, 1, 2, 1, 1);

        horizontalLayoutMessageCID = new QHBoxLayout();
        horizontalLayoutMessageCID->setObjectName(QStringLiteral("horizontalLayoutMessageCID"));
        cidTextLabel = new QLineEdit(SendCoins);
        cidTextLabel->setObjectName(QStringLiteral("cidTextLabel"));
        cidTextLabel->setEnabled(true);

        horizontalLayoutMessageCID->addWidget(cidTextLabel);

        checkBoxCID = new QCheckBox(SendCoins);
        checkBoxCID->setObjectName(QStringLiteral("checkBoxCID"));
        checkBoxCID->setChecked(true);

        horizontalLayoutMessageCID->addWidget(checkBoxCID);


        gridLayout->addLayout(horizontalLayoutMessageCID, 7, 2, 1, 1);
        ...
        payAmount_is = new EarthcoinAmountField(SendCoins_UnauthenticatedPaymentRequest);
        ...
        payAmount_s = new EarthcoinAmountField(SendCoins_AuthenticatedPaymentRequest);
        ...
        QWidget::setTabOrder(deleteButton, payAmount);
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Earthcoin address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less earthcoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        cidLabel->setText(QApplication::translate("SendCoinsEntry", "IPFS CID:", Q_NULLPTR));
