...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        welcomeLabel->setText(QApplication::translate("Intro", "Welcome to %1.", Q_NULLPTR));
        storageLabel->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where %1 will store its data.", Q_NULLPTR));
        ...
        lblExplanation1->setText(QApplication::translate("Intro", "When you click OK, %1 will begin to download and process the full %4 block chain (%2GB) starting with the earliest transactions in %3 when %4 initially launched.", Q_NULLPTR));
        lblExplanation2->setText(QApplication::translate("Intro", "This initial synchronisation is very demanding, and may expose hardware problems with your computer that had previously gone unnoticed. Each time you run %1, it will continue downloading where it left off.", Q_NULLPTR));
        lblExplanation3->setText(QApplication::translate("Intro", "If you have chosen to limit block chain storage (pruning), the historical data must still be downloaded and processed, but will be deleted afterward to keep your disk usage low.", Q_NULLPTR));
    } // retranslateUi
