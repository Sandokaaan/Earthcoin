...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", EarthcoinUnits::EAC);
...
static ProxySetting GetProxySetting(QSettings &settings, const QString &name)
{
    ...
    QStringList ip_port = settings.value(name).toString().split(":", Qt::SkipEmptyParts);  // Sando: fix a compiler warning
    if (ip_port.size() == 2) {
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/earthcoin/earthcoin/pull/8273
