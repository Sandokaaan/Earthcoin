    ...
    ipfsUrlPrefix(prefix)
{
    ...
    ui->earthcoinAtStartup->setToolTip(ui->earthcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->earthcoinAtStartup->setText(ui->earthcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openEarthcoinConfButton->setToolTip(ui->openEarthcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new EarthcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->earthcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openEarthcoinConfButton_clicked()
{
