 ...
 */
#ifndef EARTHCOIN_UTIL_H
#define EARTHCOIN_UTIL_H
...
extern const char * const EARTHCOIN_CONF_FILENAME;
extern const char * const EARTHCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("earthcoin-%s", name);
