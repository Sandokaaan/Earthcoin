...
#ifndef EARTHCOIN_WALLET_WALLET_H
#define EARTHCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this earthcoin node, and set to 0 for transactions that were created
...
#endif // EARTHCOIN_WALLET_WALLET_H
