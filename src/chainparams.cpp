...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 5000000; // Earthcoin: Use a stupidly high value as a placeholder until 1.14 locks this in
        ...
        vSeeds.emplace_back("seed.multieac.org");
        vSeeds.emplace_back("seed2.multieac.org");
