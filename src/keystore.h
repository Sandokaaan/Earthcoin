...
#ifndef EARTHCOIN_KEYSTORE_H
#define EARTHCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/earthcoin/bips/blob/master/bip-0013.mediawiki
