...
#ifndef EARTHCOIN_INTERFACES_NODE_H
#define EARTHCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a earthcoin node (earthcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // EARTHCOIN_INTERFACES_NODE_H
