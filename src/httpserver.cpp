...
#include <deque>       // a hotfix for new compilers
...
{
    RenameThread("earthcoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/earthcoin/earthcoin/pull/6990)
