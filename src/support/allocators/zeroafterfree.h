...
#ifndef EARTHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define EARTHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // EARTHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
