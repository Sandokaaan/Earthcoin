...
#ifndef EARTHCOIN_TEST_SCRIPTNUM10_H
#define EARTHCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Earthcoin Core 0.10.0, for cross-comparison.
 */
public:
