Earthcoin Core version 0.10.4 is now available from:

  <https://earthcoin.org/bin/earthcoin-core-0.10.4/>
...
- #6953 `43c2789` Split earthcoin-tx into its own package
- #6953 `dfe0d4d` Include earthcoin-tx binary on Debian/Ubuntu
