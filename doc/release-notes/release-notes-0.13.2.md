Earthcoin Core version 0.13.2 is now available from:

  <https://earthcoin.org/bin/earthcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update earthcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow earthcoin-tx to create v2 transactions (eacdrak)
