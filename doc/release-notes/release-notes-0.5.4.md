Earthcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/earthcoin/files/Earthcoin/earthcoin-0.5.4/
...
http://gitorious.org/earthcoin/earthcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Earthcoin-Qt notifications under Growl 1.3.
Increase required age of Earthcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEarthcoin properly when installing Earthcoin-Qt over it. (Windows)
