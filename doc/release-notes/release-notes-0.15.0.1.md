Earthcoin Core version *0.15.0.1* is now available from:

  <https://earthcoin.org/bin/earthcoin-core-0.15.0.1/>

and

  <https://earthcoincore.org/bin/earthcoin-core-0.15.0.1/>
