Earthcoin Core version 0.9.4 is now available from:

  https://earthcoin.org/bin/0.9.4/
...
this update is incompatible with the Earthcoin system and could lead to consensus
forks.

Earthcoin Core released binaries from https://earthcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~earthcoin/+archive/ubuntu/earthcoin
- A third-party or self-compiled Earthcoin Core

upgrade to Earthcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
