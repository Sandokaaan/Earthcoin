Earthcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/earthcoin/files/Earthcoin/earthcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Earthcoin
...
New/changed settings (command-line or earthcoin.conf file)
--------------------------------------------------------
