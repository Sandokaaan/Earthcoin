Earthcoin Core version 0.16.1 is now available from:
  ...
  <https://earthcoincore.org/bin/earthcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting earthcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure earthcoind processes are cleaned up when tests end (sdaftuar)
